...
"""
For efficiency, besides pretrained models given from those popular framework,
we use some toy models generated by ourselves to conduct prelimary experiments in the design stage. 

Below functions aims to enable us to generate/load some toy models (including CNN/FC models)
on simple classification task. 
"""
