...
class TestMXNet(unittest.TestCase):
    ...
    def test_imagenet_vgg16(self):
        ...
        self.assertAlmostEqual(neuron_coverage.get, 0.18209600477042337)
    ...
    def test_imagenet_vgg19(self):
        ...
        neuron_coverage = NeuronCoverage(threshold=0.4)
        measure_model.intermediate_layer_outputs(x_preprocessed, [neuron_coverage.update])
        self.assertAlmostEqual(neuron_coverage.get, 0.1015242242787153)
    ...
    def test_imagenet_resnet50_v2(self):
        ...
        measure_model.intermediate_layer_outputs(x_preprocessed, [neuron_coverage.update])
        self.assertAlmostEqual(neuron_coverage.get, 0.1782314402577189)
    ...
    def test_imagenet_mobilenet_v2(self):
        ...
        measure_model.intermediate_layer_outputs(x_preprocessed, [neuron_coverage.update])
        self.assertAlmostEqual(neuron_coverage.get, 0.10725342768686422)
    ...
    def test_cifar10_simple(self):
        ...
        self.assertAlmostEqual(accuracy_top_1.get, 0.687)
        self.assertAlmostEqual(accuracy_top_5.get, 0.9666)
        end = time.time()
        print('accuracy time', end - start)

        neuron_coverage = NeuronCoverage(threshold=0.6)
        measure_model.intermediate_layer_outputs(x, [neuron_coverage.update])
        self.assertAlmostEqual(neuron_coverage.get, 0.2948717948717949)
    ...
    def test_mnist_simple(self):
        ...
        accuracy_top_5 = Accuracy(ks=5)
        measure_model.predict(dataset, [accuracy_top_1.update, accuracy_top_5.update])
        self.assertAlmostEqual(accuracy_top_1.get, 0.9787)
        self.assertAlmostEqual(accuracy_top_5.get, 0.9997)
        end = time.time()
        print('accuracy time', end - start)

        neuron_coverage = NeuronCoverage(threshold=0.8)
        measure_model.intermediate_layer_outputs(x, [neuron_coverage.update])
        self.assertAlmostEqual(neuron_coverage.get, 0.3465346534653465)
