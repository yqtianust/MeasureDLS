...
class KerasModel(Model):
    ...
    def __init__(
        ...
        super(KerasModel, self).__init__(channel_axis=channel_axis, preprocessing=preprocessing)
        ...
        backward_loss = K.sum(K.batch_dot(
            predictions, backward_grad_logits, axes=-1), axis=0)
